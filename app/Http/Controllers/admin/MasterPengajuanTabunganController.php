...
class MasterPengajuanTabunganController extends Controller
{
    function index(Request $r)
    {
        ...
        $data['data'] = MasterPengajuanTabunganModel::get();
        $data['tag'] = [];
        $data['kategori'] = [];
        ...
        return view('admin.masterpengajuan.produk_tabungan', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $i = MasterPengajuanTabunganModel::updateOrCreate(['id' => $request->txtId], $input);
        if ($i) {
      ...
      public function destroy($id)
        {
            $d = MasterPengajuanTabunganModel::find($id);
            if ($d) {
                $d->delete();
