...
class MasterPengajuanKreditController extends Controller
{
      function index(Request $r)
    {
        ...
        $data['data'] = MastePengajuanKreditModel::get();
        $data['tag'] = [];
        $data['kategori'] = [];
        ...
        return view('admin.masterpengajuan.produk_kredit', $data);
    }
      ...
      public function store(Request $request)
    {
        ...
        $i = MastePengajuanKreditModel::updateOrCreate(['id' => $request->txtId], $input);
        if ($i) {
      ...
      public function destroy($id)
        {
            $d = MastePengajuanKreditModel::find($id);
            if ($d) {
                $d->delete();
