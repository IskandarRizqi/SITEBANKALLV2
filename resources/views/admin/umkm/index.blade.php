...
@section('content')
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <input id="fileThumbnail" accept="image/*" type="file" name="thumbnail"
                                class="form-control" dat-showpreview="true">
                        </div>
                ...
                gambars.forEach((g) => {
                    ...
                    $('#fileList').append(`
                        ...
                        " class="old-image-box">
                            ...
                            <button type="button"
                                onclick="hapusGambarLama(this,'${g}')"
                                style="
                                    position:absolute;
                                    top:-6px;
                                    right:-6px;
                            ...
                            <input type="hidden" name="gambar_lama[]" value="${g}">
    ...
    <script>
        function hapusGambarLama(button, path) {



            let box = button.closest('.old-image-box');

            if (box) {
                box.remove();
            }

            // tambahkan input hidden untuk menandai gambar dihapus
