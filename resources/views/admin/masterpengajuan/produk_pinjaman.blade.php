                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="btn btn-sm btn-danger"
                                                                    onclick="confirmdelete('/salamprofit/master-produk-pinjaman/{{ $v->id }}')"><i
    ...
    <div id="modalInputProduk" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form action="/salamprofit/master-produk-pinjaman" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="txtId" id="txtId" hidden>
                    <!-- BEGIN: Modal Header -->
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Master Produk Pinjaman</h2>
                    </div>
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            <label for="txtmin" class="form-label">Minimal DP</label>
                            <div class="input-group">
