                            ...
                            <div class="box p-5">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-2">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <form action="/salamprofit/master-jenis-agunan" method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="btn btn-sm btn-danger"
                                                            onclick="confirmdelete('/salamprofit/master-jenis-agunan/{{$v->id}}')"><i
...
<div id="modalInputProduk" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="/salamprofit/master-jenis-agunan" method="post" enctype="multipart/form-data">
                @csrf
                <input type="text" name="txtId" id="txtId" hidden>
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Master Jenis Agunan</h2>
                </div>
