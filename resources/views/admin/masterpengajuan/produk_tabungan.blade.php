                                ...
                                <div class="box p-5">
                                    ...
                                    <div class="grid grid-cols-12 gap-6 mt-2">
                                        ...
                                        <div class="col-span-12 lg:col-span-6">
                                            <form action="/salamprofit/master-produk-tabungan" method="get">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="btn btn-sm btn-danger"
                                                                    onclick="confirmdelete('/salamprofit/master-produk-tabungan/{{ $v->id }}')"><i
    ...
    <div id="modalInputProduk" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form action="/salamprofit/master-produk-tabungan" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="txtId" id="txtId" hidden>
                    <!-- BEGIN: Modal Header -->
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Master Pengajuan Tabungan</h2>
                    </div>
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            <label for="txtmin" class="form-label">Minimal Setoran</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light" style="pointer-events:none;">Rp</span>
                                <input id="txtmin" name="min" type="number" class="form-control" placeholder="0">
                            </div>
                        </div>
