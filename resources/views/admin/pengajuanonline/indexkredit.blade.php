                            ...
                            <div class="box p-5">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-2">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <form action="/salamprofit/data-pengajuan-kredit" method="get">
                                        ...
                                        <table id="datatabledefault">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$v->no_hp}}</td>
                                                    <td>{{$v->pekerjaan}}</td>
                                                    <td>Rp. {{$v->jml_kredit}} </td>
                                                    <td>{{$v->jngka_wkt}} Bulan</td>
                                                    
                                                   
                                                    <td>
                                                       <a href="{{ route('formkredit.download', $v->id) }}" target="_blank" class="btn btn-sm btn-primary">
                                                              <i data-lucide="eye"></i>
                                                        </a>
