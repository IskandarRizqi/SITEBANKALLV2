                ...
                <div class="row align-items-center text-center">
                    <div class="col-lg-8 m-auto">
                        <div class="main-heading">
                            <h1 style="font-size: 35px; margin-top: 30px;"> Term & Conditions</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="service-details-post">
                            <article>
                                <div class="details-post-area">
                                    <div class="image">
                                        <img src="frontend/bprbkkbatang/assets/img/profil/term.jpg" alt="">
                                    </div>
                                    ...
                                    <div class="heading1">
                                        ...
                                        <p style="text-align: justify;">
                                            Selamat datang di situs resmi BPR BKK Batang, Dengan mengakses dan menggunakan
                                        ...
                                        <p style="text-align: justify;">
                                            Situs ini disediakan sebagai sarana informasi seputar layanan dan produk BPR
                                            BKK Batang. Pengguna tidak diperkenankan: Menggunakan situs untuk tujuan yang
                                        ...
                                        <p style="text-align: justify">
                                            ...
                                            milik BPR BKK Batang dan dilindungi oleh undang-undang yang berlaku.
                                        ...
                                        <p style="text-align: justify">
                                            ...
                                            kami. BPR BKK Batang tidak bertanggung jawab atas isi atau kebijakan situs
                                            pihak ketiga tersebut.
                                        </p>

                                        <p><strong>6. Pembatasan Tanggung Jawab</strong></p>
                                        <p style="text-align: justify">
                                            BPR BKK Batang tidak bertanggung jawab atas kerugian langsung atau tidak
