...
<div class="header-top">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="pera">
                    <p>BPR Kedu Arthasetia, Mitra Tepat untuk Tumbuh dan Berkembang</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="header-elements">
                        <div class="site-logo">
                            <a href="/">
                                <img src="frontend/bprkeduarthasetia/assets/img/logo/logokedu.png" style="height: 30px;"
                                    alt="">
                            </a>
                        </div>
                        ...
                        <div class="main-menu-ex main-menu-ex1">
                            <ul>
                                ...
                                <li class="dropdown-menu-parrent"><a href="#">Simulasi <i
                                            class="fa-solid fa-angle-down"></i></a>
                                    <ul>
                                ...
                                <li class="dropdown-menu-parrent"><a href="#">Laporan <i
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/piagamaudit">Piagam Audit Internal </i></a></li>
        ...
        <div class="col-12">
            <div class="mobile-header-elements">
                <div class="mobile-logo">
                    <a href="/"><img src="frontend/bprkeduarthasetia/assets/img/logo/logokedu.png"
...
<div class="mobile-sidebar d-block d-lg-none">
    <div class="logo-m">
        <a href="/"><img src="frontend/bprkeduarthasetia/assets/img/logo/logokedu.png" style="height: 60px; width: 50px;"
                alt=""></a>
    </div>
        ...
        <ul>
            ...
            <div class="single-footer-items">
                ...
                <div class="contact-box">
                    <div class="icon">
                        <img src="frontend/bprkeduarthasetia/assets/img/icons/footer1-icon1.png" alt="">
                    </div>
                    <div class="pera">
                ...
                <div class="contact-box">
                    <div class="icon">
                        <img src="frontend/bprkeduarthasetia/assets/img/icons/wa.png" alt=""
                ...
                <div class="contact-box">
                    <div class="icon">
                        <img src="frontend/bprkeduarthasetia/assets/img/icons/footer1-icon3.png" alt="">
                    </div>
                    <div class="pera">
