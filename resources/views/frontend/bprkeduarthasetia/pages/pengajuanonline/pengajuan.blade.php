        ...
        <div class="row align-items-center text-center">
            <div class="col-lg-8 m-auto">
                <div class="main-heading">
                    ...
                    <span class="span"><a href="/">Home</a> <span class="arrow"><i
...
<div class="container" style="margin-top: 40px; margin-bottom: 40px;">
            ...
            <div class="row layout-top-spacing">
                <div class="col-md-6">
                    <div class="form-group row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control">
                                ...
                                <option
                                    value="{{$k->nominal.'---'.$k->tenor.'---'.$k->id.'---'.$k->image.'---'.$k->nama.'---'.$k->nominal}}"
                    ...
                    <div class="form-group row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="plafon" id="plafon" value="" min="0">
                            </div>
                    ...
                    <div class="form-group row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                <input type="number" class="form-control" name="tenor" id="tenor" value="" min="0">
                                <div class="input-group-append">
                    ...
                    <div class="form-group row" style="margin-bottom: 10px;">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="angsuran" id="angsuran" value=""
                                    readonly>
                            </div>
                ...
                <div class="col-md-6 mb-2">
                    <div class="layout-top-spacing justify-content-md-center">
                        ...
                        <div class="card-body">
                            <div class="">
                                <img class="" style="border-radius: 5px;" id="imageKreditProduk" width="520px"
                                    height="316px">
                            </div>
                        </div>
                            ...
                            <div class="card" style="margin-bottom: 15px;">
                                <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                    <section class="mb-0 mt-0" style="padding: 0 !important">
                                        <div role="menu" class="d-flex justify-content-between align-items-center"
                                            data-toggle="collapse" data-target="#kreditAccordionOne"
                                            aria-expanded="true" aria-controls="kreditAccordionOne"
                                ...
                                <div id="kreditAccordionOne" class="collapse " aria-labelledby="..."
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="alamat" id="alamat" value=""
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card" style="margin-bottom: 15px;">
                                <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                    <section class="mb-0 mt-0" style="padding: 0 !important">
                                        <div role="menu" class="d-flex justify-content-between align-items-center"
                                            data-toggle="collapse" data-target="#kreditAccordionFour"
                                            aria-expanded="true" aria-controls="kreditAccordionFour"
                                            style="cursor: pointer; padding: 1px;">
                                ...
                                <div id="kreditAccordionFour" class="collapse" aria-labelledby="..."
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_kantor" value=""
                                                name="nama_kantor" />
                                            @error('nama_kantor')
                                            <div class="text-danger">
                                                Harus Diisi
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bidang_pekerjaan" value=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="lama_bekerja" value=""
                                                name="lama_bekerja" />
                                            @error('lama_bekerja')
                                            <div class="text-danger">
                                                Harus Diisi
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="npwp_nasabah" value=""
                                                name="npwp_nasabah" />
                                            @error('npwp_nasabah')
                                            <div class="text-danger">
                                                Harus Diisi
                                        ...
                                        <div class="form-group">
                                            <label>RT/RW</label>
                                            <input type="text" class="form-control" id="rtrw" name="rtrw" value="" />
                                            @error('rtrw')
                                            <div class="text-danger">
                                                Harus Diisi
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kelurahan" value=""
                                                name="kelurahan" />
                                            @error('kelurahan')
                                            <div class="text-danger">
                                                Harus Diisi
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kecamatan" value=""
                                                name="kecamatan" />
                                            @error('kecamatan')
                                            <div class="text-danger">
                                                Harus Diisi
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kabupaten" value=""
                                                name="kabupaten" />
                                            @error('kabupaten')
                                            <div class="text-danger">
                                                Harus Diisi
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="faksimili" value=""
                                                name="faksimili" />
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                    <section class="mb-0 mt-0" style="padding: 0 !important">
                                        <div role="menu" class="d-flex justify-content-between align-items-center"
                                            data-toggle="collapse" data-target="#kreditAccordionThree"
                                            aria-expanded="true" aria-controls="kreditAccordionThree"
                                            style="cursor: pointer; padding: 1px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="transaksi_normal_harian"
                                                name="transaksi_normal_harian" value="}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sumber_lainnya" value="" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nominal_sumber_lainnya"
                                                name="nominal_sumber_lainnya" value="" />
            ...
            <div class="n-chk" style="margin-top: 20px;">
                <label class="new-control new-checkbox checkbox-primary">
                    ...
                    <span class="new-control-indicator"></span><span data-toggle="modal"
                        data-target="#syaratKredit">Syarat &
                        Ketentuan Berlaku</span>
                </label>
            </div>
            {{-- <button type="submit" class="btn btn-primary mt-3" id="simpanKredit" disabled>Simpan</button> --}}
            <!-- Modal -->
            <div class="modal fade" id="syaratKredit" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                        ...
                        <div class="modal-body" style="background-color: white;">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-justify">
                                    Saya menyatakan memahami dan bersedia untuk dilakukan pengecekan data pribadi saya
                                    guna
    ...
    <div class="tab-content hidden" id="form2">
        <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row layout-top-spacing">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="depo_nominal" id="depo_nominal"
                                        min="0" value="">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="depo_jangka_waktu"
                                        id="depo_jangka_waktu" value="" min="0">
                                    <div class="input-group-append">
                                        <span class="input-group-text">Bulan</span>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="layout-top-spacing justify-content-md-center">
                            ...
                            <div class="card-body">
                                ...
                                <img class="m-1" id="imageDepositoProduk" style="border-radius: 5px;" width="520px;"
                                    height="200px">
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card" style="margin-bottom: 15px;">
                                    <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                        <section class="mb-0 mt-0" style="padding: 0 !important">
                                            <div role="menu" class="d-flex justify-content-between align-items-center"
                                                data-toggle="collapse" data-target="#depositoAccordionOne"
                                                aria-expanded="true" aria-controls="depositoAccordionOne"
                                                style="cursor: pointer; padding: 1px;">
                                                <span>Data Pribadi</span>
                                                <i class="fas fa-chevron-down"></i>
                                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card" style="margin-bottom: 15px;">
                                    <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                        <section class="mb-0 mt-0" style="padding: 0 !important">
                                            <div role="menu" class="d-flex justify-content-between align-items-center"
                                                data-toggle="collapse" data-target="#depositoAccordionFour"
                                                aria-expanded="true" aria-controls="depositoAccordionFour"
                                                style="cursor: pointer; padding: 1px;">
                                                <span>Data Pekerjaan</span>
                                                <i class="fas fa-chevron-down"></i>
                                            </div>
                                    ...
                                    <div id="depositoAccordionFour" class="collapse" aria-labelledby="..."
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Alamat Surat Menyurat <strong
                                                        class="text-danger">*</strong></label>
                                                <select class="form-control" id="alamat_surat_menyurat"
                                                    name="alamat_surat_menyurat">
                                                    <option value="">Pilih</option>
                                ...
                                <div class="card">
                                    <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                        <section class="mb-0 mt-0" style="padding: 0 !important">
                                            <div role="menu" class="d-flex justify-content-between align-items-center"
                                                data-toggle="collapse" data-target="#depositoAccordionThree"
                                                aria-expanded="true" aria-controls="depositoAccordionThree"
                                                style="cursor: pointer; padding: 1px;">
                                                <span>Data Keuangan</span>
                                                <i class="fas fa-chevron-down"></i>
                                            </div>
                                    ...
                                    <div id="depositoAccordionThree" class="collapse" aria-labelledby="..."
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label>Penghasilan Perbulan <strong
                                                        class="text-danger">*</strong></label>
                                                <select class="form-control" name="penghasilan_perbulan">
                                                    <option value="">Pilih</option>
                                                    <option value="5000000"></option>
            ...
            <!-- Modal -->
            <div class="modal fade" id="syaratDeposito" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-body" style="background-color: white;">
    ...
    <div class="tab-content hidden" id="form3">
        <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control" name="tabu_produk" id="tabu_produk">
                                    ...
                                    <option
                                        value="{{$tabungan->id.'---'.$tabungan->image.'---'.$tabungan->minimal_setoran}}"
                                        {{old('tabu_produk')?'selected':''}}>
                    ...
                    <div class="col-md-6 mb-2">
                        <div class="layout-top-spacing justify-content-md-center">
                            <div class="card-body">
                                ...
                                <img class="m-1" style="border-radius: 5px;" id="imageTabunganProduk" width="520px;"
                                    height="200px">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="card" style="margin-bottom: 15px;">
                                    <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                        <section class="mb-0 mt-0" style="padding: 0 !important">
                                            <div role="menu" class="d-flex justify-content-between align-items-center"
                                                data-toggle="collapse" data-target="#tabunganAccordionOne"
                                                aria-expanded="true" aria-controls="tabunganAccordionOne"
                                                style="cursor: pointer; padding: 1px;">
                                                <span>Data Pribadi</span>
                                                <i class="fas fa-chevron-down"></i>
                                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card" style="margin-bottom: 15px;">
                                    <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                        <section class="mb-0 mt-0" style="padding: 0 !important">
                                            <div role="menu" class="d-flex justify-content-between align-items-center"
                                                data-toggle="collapse" data-target="#tabunganAccordionFour"
                                                aria-expanded="true" aria-controls="tabunganAccordionFour"
                                                style="cursor: pointer; padding: 1px;">
                                                <span>Data Pekerjaan</span>
                                                <i class="fas fa-chevron-down"></i>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header  text-white" style="background-color: #3059CE;" id="...">
                                        <section class="mb-0 mt-0" style="padding: 0 !important">
                                            <div role="menu" class="d-flex justify-content-between align-items-center"
                                                data-toggle="collapse" data-target="#tabunganAccordionThree"
                                                aria-expanded="true" aria-controls="tabunganAccordionThree"
                                                style="cursor: pointer; padding: 1px;">
                                                <span>Data Keuangan</span>
                                                <i class="fas fa-chevron-down"></i>
                                            </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="syaratTabungan" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-body" style="background-color: white;">
