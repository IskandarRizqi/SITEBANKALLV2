        ...
        <div class="row align-items-center text-center">
            <div class="col-lg-10 m-auto">
                <div class="main-heading">
                    <h1 style="font-size: 35px; color: #fff;">BERITA</h1>
                    <!-- <span class="span">  <a href="/">Berita</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Informasi</span>
                         -->
                </div>
            </div>
                            ...
                            <a href="{{ route('detliterasi', $item->id) }}" class="text-decoration-none text-dark">
                                ...
                                <div id="imageCarousel{{ $item->id }}" class="carousel slide" data-bs-ride="carousel"
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div
                                            class="carousel-item {{ !$item->thumbnail && $loop->first ? 'active' : '' }}">
                                ...
                                <div class="heading1">
                                    ...
                                    <h4 class="mt-2">
                                        <p class="mb-0 fw-bold text-truncate-2" style="color:#000;">{{ $item->title }}
                                        </p>
                                    </h4>
                                    <br>
                    ...
                    <a href="{{ route('detberita', $item->id) }}" class="text-decoration-none text-dark">
                        ...
                        <div id="imageCarousel{{ $item->id }}" class="carousel slide" data-bs-ride="carousel"
                            ...
                            <div class="carousel-inner">
                                @if($item->thumbnail)
                                <div class="carousel-item active">
                                    <img src="/recfil?display=true&rf={{ $item->thumbnail }}" class="d-block w-100"
