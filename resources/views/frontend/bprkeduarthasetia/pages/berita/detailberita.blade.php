              ...
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35px;">INFORMASI</h1>
                    <span class="span"><img src="{{asset('frontend/bprjas/assets/img/icons/span1.png')}}" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Informasi <span class="arrow">
                </div>
              </div>
            </div>
          </div>
                            ...
                            <article>
                                <div class="details-post-area" style="padding:10px; max-width:100%; overflow-x:hidden;">
                                    ...
                                    <div class="social-users">
                                        <ul>
                                            <li><a href="#"><img src="{{ asset('frontend/bprjas/assets/img/icons/user-icon2.png') }}" alt=""> {{ \Carbon\Carbon::parse($berita->tanggal_tampil)->format('d F Y') }}</a></li>
                                            <li><a href="#"><img src="{{ asset('frontend/bprjas/assets/img/icons/user-icon3.png') }}" alt=""> {{ $berita->tag }}</a></li>
                                        </ul>
                                    </div>
                                    <br>
                                    <div class="heading1">
