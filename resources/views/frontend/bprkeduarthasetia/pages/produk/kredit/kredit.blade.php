      ...
      <div class="row align-items-center text-center">
        <div class="col-lg-8 m-auto">
          <div class="main-heading">
            <h1 style="font-size: 35px; color: #fff;">KREDIT</h1>

            <span class="span"> <a href="/">Beranda</a> <span class="arrow"><i
                  class="fa-regular fa-angle-right"></i></span> Produk <span class="arrow"><i
                  class="fa-regular fa-angle-right"></i></span> Kredit</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="sidebar-box-area sidebar-bg mb-40">
            ...
            <ul class="features-list">
              <li><a href="kreditinvestasi">Kredit Investasi <span><i class="fa-regular fa-angle-right"></i></span></a>
              </li>
              <li><a href="kreditkonsumtif">Kredit Konsumtif <span><i class="fa-regular fa-angle-right"></i></span></a>
              </li>
              <li><a href="kreditmodalusaha">Kredit Modal Usaha <span><i
                      class="fa-regular fa-angle-right"></i></span></a></li>
              <li><a href="kreditmultiguna">Kredit Multiguna <span><i class="fa-regular fa-angle-right"></i></span></a>
              </li>
            </ul>
          </div>
            ...
            <article>
              <div class="details-post-area">
                ...
                <div class="heading1">
                  ...
                  <p>Kredit pada BPR (Bank Perkreditan Rakyat) adalah fasilitas pembiayaan yang diberikan oleh BPR
                    kepada nasabah perorangan maupun badan usaha untuk berbagai keperluan seperti modal usaha, konsumsi,
                    maupun investasi. Kredit ini diberikan dengan syarat dan ketentuan tertentu serta umumnya dijamin
                    dengan agunan (jaminan).</p> <br>
