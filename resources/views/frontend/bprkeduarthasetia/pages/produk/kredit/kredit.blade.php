              ...
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35px; color: #fff;">KREDIT</h1>
                    ...
                    <span class="span"> <a href="index.html">Beranda</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Produk <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Kredit</span>
                </div>
              </div>
            </div>
          </div>
