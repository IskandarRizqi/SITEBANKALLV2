                ...
                <div class="row align-items-center text-center">
                    <div class="col-lg-8 m-auto">
                        <div class="main-heading">
                            <h1 style="font-size: 35px">DETAIL KREDIT </h1>
                            <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a
                                    href="index.html">Home</a> <span class="arrow"><i
                                        ...
                                        class="fa-regular fa-angle-right"></i></span>Detail Kredit</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="service-details-post">
                            <article>
                                <div class="details-post-area">
                                    <div class="image">
                                        <img src="/recfil?display=true&rf={{ $kredit->banner }}"
                                            style="height: 800px; border-radius:5px 5px;"
                                            alt="{{ $kredit->title ?? 'kredit' }}">
                                    </div>
                                    <div class="space30"></div>
                                    <div class="heading1">
                                        <h2 style="font-size: 30px;">{{ $kredit->title }}</h2>
