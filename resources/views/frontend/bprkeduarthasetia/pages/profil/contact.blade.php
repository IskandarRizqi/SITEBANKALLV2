                ...
                <div class="col-lg-6">
                    <div class="contact-boxs">
                        <div class="heading1">
                            ...
                            <p style="text-align:justify">Jika Anda mempunyai pertanyaan mengenai produk dan layanan BPR
                                JAS atau ingin menyampaikan Informasi, Saran, Pengalaman, ataupun Keluhan yang dapat
                                memperbaiki kinerja kami, silakan mengisi formulir dibawah.</p>
                        </div>
                        ...
                        <div class="contact-box">
                            ...
                            <div class="heading">
                                <h5>Email</h5>
                                <a href="mailto:juwanaarthasentosa@yahoo.com " class="text">juwanaarthasentosa@yahoo.com
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="contact-form-details">
                        <form onsubmit="sendToWhatsApp(event)">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" class="theme-btn1">Kirim <span><i
