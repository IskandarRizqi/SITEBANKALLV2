            ...
            <div class="row align-items-center text-center">
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35px; color: #fff;">PENGURUS</h1>
                    <span class="span"><a href="index.html">Beranda</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Profil <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Pengurus <span class="arrow">
                </div>
              </div>
            </div>
          </div>
