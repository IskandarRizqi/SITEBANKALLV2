        ...
        <div class="col-lg-8 m-auto">
          <div class="main-heading">
            ...
            <span class="span"><a href="/">Beranda</a> <span class="arrow"><i
                  ...
                  class="fa-regular fa-angle-right"></i></span> Pengurus <span class="arrow">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="sidebar-box-area sidebar-bg mb-40">
            ...
            <ul class="features-list">
              ...
              <li><a href="organisasi">Struktur Organisasi<span><i class="fa-regular fa-angle-right"></i></span></a>
              </li>
