            ...
            <div class="col-lg-10 m-auto">
                <div class="main-heading">
                    ...
                    <span class="span"> <a href="/">Beranda</a> <span class="arrow"><i
                                ...
                                class="fa-regular fa-angle-right"></i></span> Gallery</span>
                </div>
            </div>
                    ...
                    <div id="carousel-{{ \Illuminate\Support\Str::slug($title) }}" class="carousel slide"
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item @if($key==0) active @endif">
                                <img src="/recfil?display=true&rf={{ $item->image }}" alt="{{ $item->title }}"
                                    class="d-block w-100" style="border-radius:8px; height:360px; object-fit:cover;">
                            </div>
                            @endforeach
                        </div>
                        ...
                        <button class="carousel-control-prev" type="button"
                            data-bs-target="#carousel-{{ \Illuminate\Support\Str::slug($title) }}" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon"></span>
                        </button>
                        <button class="carousel-control-next" type="button"
                            data-bs-target="#carousel-{{ \Illuminate\Support\Str::slug($title) }}" data-bs-slide="next">
