<head>
        <meta charset="utf-8">
        <title>BPR Eleska Artha</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="" name="description">

        <link rel="shortcut icon" href="{{asset('frontend/bpreleska/assets/img/logo/logo2.png')}}" type="image/x-icon">
        ...
        <!-- Swiper -->
        <link href="{{asset('frontend/bpreleska/assets/css/swiper-bundle.min.css')}}" rel="stylesheet"/>
        <!-- all min css -->
        <link rel="stylesheet" href="{{asset('frontend/bpreleska/assets/css/all.min.css')}}"/>
        <!-- magnific CSS -->
