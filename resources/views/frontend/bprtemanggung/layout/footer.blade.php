<footer class="footer">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-envelope" style="margin-right: 10px;"></i> <a href="mailto:kpotemanggung@yahoo.com">kpotemanggung@yahoo.com</a></li>
        ...
        <div class="col-lg-2 col-md-12">
          <p>BPR BKK Temanggung berizin dan diawasi oleh Otoritas Jasa Keuangan (OJK) serta merupakan peserta penjaminan LPS</p>
        </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">PT. BPR BKK Temanggung (Perseroda)</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
