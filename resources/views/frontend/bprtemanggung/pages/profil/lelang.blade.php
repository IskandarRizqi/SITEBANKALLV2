...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb">
        ...
        <div class="container text-center ">
            <img src="frontend/bprtemanggung/assets/img/banner/lelang.jpg" alt="">
        </div>
    </div>
                                                ...
                                                <div class="p-3 text-center">
                                                    ...
                                                    <div class="d-flex justify-content-between small mb-2">
                                                        <span>Nilai Limit<br><strong
                                                                class="">Rp.{{ number_format($item->limit, 0, ',', '.') }}</strong></span>
                                                        <span >Uang
                                                            Jaminan<br><strong class="">Rp.{{ number_format($item->jaminan, 0, ',', '.') }}</strong></span>
                                                    </div>
                                                    ...
                                                    <span class="btn btn-sm btn-danger w-100 fw-bold">OPEN
                                                        BIDDING</span>
                                                </div>
                                            </div>
                                        </a>
