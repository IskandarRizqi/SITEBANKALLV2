                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="th-widget-contact">
                            <div class="info-box_text" style="display:flex; align-items:center; gap:10px;">
                                <div class="icon">
                                    <img src="{{ asset('frontend/bprbaja/assets/img/icon/phone.svg') }}" alt="img"
                                        style="width:20px;">
                                </div>
                                <div class="details">
                                    <p style="margin:0;">
                            ...
                            <div class="info-box_text" style="display:flex; align-items:center; gap:10px;">
                                <div class="icon">
                                    <img src="{{ asset('frontend/bprbaja/assets/img/icon/envelope.svg') }}" alt="img"
                                        style="width:20px;">
                                </div>
                                <div class="details">
                                    <p style="margin:0;">
                                        <a href="mailto:mailinfo00@atek.com" class="info-box_link" style="color:#fff;">
                                            bprbaja@gmail.com
                                        </a>
                                    </p>
                                </div>
