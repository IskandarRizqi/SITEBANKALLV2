              ...
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35px;">KEGIATAN EVENT</h1>
                    <span class="span"><img src="{{asset('frontend/bprjas/assets/img/icons/span1.png')}}" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Kegiatan Event <span class="arrow">
                </div>
              </div>
            </div>
          </div>
                        ...
                        <div class="service-details-post">
                            <article>
                               <div class="details-post-area" style="padding:10px; max-width:100%; overflow-x:hidden;">
                                <div id="eventCarousel{{ $event->id }}" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="3000">
                                ...
                                <div class="social-users">
                                    <ul>
                                        {{-- <li><a href="#"><img src="{{ asset('frontend/bprjas/assets/img/icons/user-icon1.png') }}" alt=""> {{Event}}</a></li> --}}
                                        <li><a href="#"><img src="{{ asset('frontend/bprjas/assets/img/icons/user-icon2.png') }}" alt=""> {{ \Carbon\Carbon::parse($event->created_at)->format('d M Y') }}</a></li>
                                        <li><a href="#"><img src="{{ asset('frontend/bprjas/assets/img/icons/user-icon3.png') }}" alt=""> {{$event->tag}}</a></li>
                                    </ul>
                                </div>
                                <br>
                                <div class="heading1">
