                                ...
                                <div class="col-lg-8 m-auto">
                                  <div class="main-heading">
                                    <h1 style="font-size: 35px">Event Kegiatan</h1>
                                      <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> event kegiatan</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                                  ...
                                  @foreach ($event as $item)
                                    <div class="col-lg-4">
                                        <a href="{{ route('detevent', $item->id) }}" style="text-decoration:none; color:inherit; display:block;">
                                            <div style="background:#fff; border-radius:10px; box-shadow:0 4px 8px rgba(0,0,0,0.1); overflow:hidden; font-family:'Archivo', sans-serif; margin-bottom:20px;">
