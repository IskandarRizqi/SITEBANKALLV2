                  ...
                  <div class="col-lg-10 m-auto">
                    <div class="main-heading">
                      <h1 style="font-size: 35px">Frequently Asked Question ( FAQ )
                        ...
                        <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> FAQ</span>
                    </div>
                  </div>
            ...
            <div class="accordion accordion1 accordion-flush" id="accordionFlushExample">
              <div class="accordion-item active" data-aos="fade-up" data-aos-duration="700">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">
                   BPR NUSAINTIM adalah lembaga keuangan bank yang melayani masyarakat dalam hal simpanan dan pembiayaan, dengan fokus pada sektor usaha mikro, kecil, dan menengah (UMKM), serta individu.
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-duration="1200">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Ya. BPR NUSAINTIM menerima simpanan dalam bentuk tabungan dan deposito berjangka, dan juga dijamin oleh Lembaga Penjamin Simpanan (LPS) sesuai dengan ketentuan yang berlaku.</div>
                </div>
              </div>
              <div class="accordion-item" data-aos="fade-up" data-aos-duration="900">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Ya, dana nasabah di BPR NUSAINTIM dijamin oleh LPS (Lembaga Penjamin Simpanan) hingga jumlah tertentu, sesuai dengan syarat dan ketentuan yang berlaku.</div>
                </div>
              </div>
              <div class="accordion-item" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Masyarakat umum, pelaku usaha mikro, kecil, hingga menengah, serta karyawan dengan penghasilan tetap, dapat mengajukan kredit sesuai dengan persyaratan yang ditentukan.</div>
                </div>
              </div>
            ...
            <div class="accordion accordion2 accordion-flush" id="accordionFlushExample2">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-duration="900">
                ...
                <div id="flush-collapseSeven" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven" data-bs-parent="#accordionFlushExample2">
                  <div class="accordion-body"> BPR NUSAINTIM kini menyediakan layanan mobile banking, internet banking, atau SMS banking, Untuk Mempermudah Nasabah </div>
                </div>
              </div>
              <div class="accordion-item" data-aos="fade-up" data-aos-duration="1200">
              ...
              <div class="accordion-item active" data-aos="fade-up" data-aos-duration="1200">
                ...
                <div id="flush-collapseTen" class="accordion-collapse collapse show" aria-labelledby="flush-headingTen" data-bs-parent="#accordionFlushExample2">
