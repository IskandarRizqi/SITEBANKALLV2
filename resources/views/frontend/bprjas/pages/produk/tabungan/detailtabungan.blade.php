              ...
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35PX">DETAIL TABUNGAN</h1>
                    <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Produk <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Detail Tabungan</span>
                </div>
              </div>
            </div>
          </div>
