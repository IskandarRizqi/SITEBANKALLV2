                ...
                <div class="row align-items-center text-center">
                    <div class="col-lg-8 m-auto">
                        <div class="main-heading">
                            <h1 style="font-size: 35px">DETAIL DEPOSITO</h1>
                            <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a
                                    href="index.html">Home</a> <span class="arrow"><i
                                        ...
                                        class="fa-regular fa-angle-right"></i></span>Detail Deposito</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-box-area sidebar-bg mb-40">
                            ...
                            @foreach ($other_deposito as $item)
                                <li>
                        ...
                        <div class="service-details-post">
                            <article>
                                <div class="details-post-area">
                                    <div class="image">
                                        <img src="/recfil?display=true&rf={{ $deposito->banner }}"
                                            style="height: 800px; border-radius:5px 5px;"
                                            alt="{{ $deposito->title ?? 'deposito' }}">
                                    </div>
                                    <div class="space30"></div>
                                    <div class="heading1">
                                        <h2 style="font-size: 30px;">{{ $deposito->title }}</h2>
