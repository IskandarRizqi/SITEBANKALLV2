...
@section('content')
    ...
    <div style="width:100%; overflow:hidden; ">
        <img src="{{ asset('frontend/bprtaruna/assets/img/produk/deposito/deposito.png') }}"
            style="object-fit: fill; height: auto;margin-top: 75px;" alt="Banner" class="banner-img">
    </div>
    ...
    <div class="team2 team-page sp" style="padding-top: 50px;">
        <div class="container">
            <br>
            <h2 style="text-align: center; font-weight: bold; margin-bottom: 30px; color: #000000;">Produk Deposito</h2>
            <div class="row">
