...
@section('content')
    ...
    <body class="body tg-heading-subheading animation-style3">
        ...
        <div style="width:83%; margin:auto; background:#0936ec; padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
            ...
            <div class="simulasi-wrapper" style="display:flex;">
                ...
                <div class="simulasi-left" style="width:55%; color:white; padding-right:20px;" class="simulasi-left">
                    ...
                    <div
                        ...
                        <span style="color:#f71827; font-weight:bold; margin-right:10px;">Rp.</span>
                    ...
                    <div
                        ...
                        <span style="color:#f71827; font-weight:bold; margin-left:10px;">Bulan</span>
                    </div>
                    ...
                    <div
                        ...
                        <span style="color:#f71827; font-weight:bold; white-space:nowrap; margin-left:10px;">
                            % / Tahun
                        </span>
                    </div>
                    ...
                    <div style="display:flex; justify-content:space-between; margin-top:5px; margin-bottom:20px;"
                        ...
                        <button id="btnReset"
                            style="width:40%; padding:12px; border-radius:30px; background:#f71827;
                        ...
                        border:none; color:#f71827; font-weight:bold; font-size:14px;">
                            Hitung
                        </button>
                ...
                <div class="simulasi-right" style="width:45%; display:flex; align-items:center; justify-content:center;"
                    ...
                    <img src="frontend/bprtaruna/assets/img/produk/simulasikredit.png" style="width:95%; height: 350px; border-radius:10px;">
                </div>
            ...
            <div id="hasilSimulasiContainer" style="width:100%; margin-top:30px; display:none;">
                <div style="background:white; border-radius:10px; padding:20px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    <h4 style="color:#f71827; margin-bottom:15px; text-align:center;">Hasil Simulasi Pinjaman</h4>
