              ...
              <div class="hamburger_top d-flex align-items-center justify-content-between">
                  <div class="hamburger_logo">
                      <a href="index.html" class="mobile_logo">
                          <img src="frontend/bprapm/assets/images/logos/logo-2.webp" alt="Logo">
                      </a>
                  </div>
          ...
          <div class="row">
              <div class="col-12">
                  <div class="header-wrapper">
                      <!-- site logo -->
                      <div class="site_logo">
                          <a class="logo" href="index.html"><img src="frontend/bprapm/assets/images/logos/logo.png"
                                  alt=""></a>
                      </div>
                      ...
                      <div class="menu-area d-none d-lg-inline-flex align-items-center">
                          <nav id="mobile-menu" class="mainmenu">
                             <ul>
                                  ...
                                  <li class="has-dropdown"><a href="blog.html">Produk</a>
                                      <ul class="sub-menu">
                                  ...
                                  <li class="has-dropdown"><a href="blog.html">Laporan</a>
                                      <ul class="sub-menu">
