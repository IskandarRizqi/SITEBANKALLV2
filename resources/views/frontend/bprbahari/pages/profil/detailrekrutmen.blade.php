...
@section('content')
    ...
    <div class="pxn-page-header" data-bg-image="{{asset('frontend/bprbahari/assets/images/profil/banertop.jpg')}}"
                ...
                <div class="col-lg-8">
                    <div class="pxn_post_details_wrap">
                        ...
                        <div class="pxn_post_content">
                            ...
                            {{-- <div class="mt-4">
                                <a href="mailto:hrd@bprbahari.co.id" class="th-btn">Apply Posisi Ini</a>
                            </div> --}}
