                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> {{ $kredit->title ?? 'Kredit' }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div style="max-width:1200px;margin:0 auto;">
            ...
            <div style="margin-top:30px;">
                <a href="/formpengajuankredit"
                    style="display:inline-block; background:#ad1414; color:#fff; padding:12px 30px; border-radius:20px; font-size:16px; font-weight:600;
