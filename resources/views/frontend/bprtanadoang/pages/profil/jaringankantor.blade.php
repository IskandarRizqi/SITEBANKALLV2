...
{{-- 
    ...
    <div class="page-wrap">
        <div class="slider-box" aria-label="Slider Kantor">
            {{-- <h2 style="text-align:center; font-weight:700; color:#1578f1; margin:26px 0 8px;">JARINGAN KANTOR</h2> --}}
            <div id="slideViewport" role="list">
                ...
                <section class="slide" role="listitem" aria-label="Kantor Pusat" style="padding: 25px 60px">
                    <div class="row">
                        <div class="col-left">
                            <h3 style="color:#1578f1; font-size:22px; margin:6px 0 18px;">Kantor Pusat</h3>
                ...
                <section class="slide" role="listitem" aria-label="Kantor Cabang" style="padding: 25px 60px">
                    <div class="row">
                        <div class="col-left">
                            <h3 style="color:#1578f1; font-size:22px; margin:6px 0 18px;">{{ $cabang->kantor }}</h3>
                ...
                <section class="slide" role="listitem" aria-label="Kantor Cabang 2" style="padding: 25px 60px">
                    <div class="row">
                        <div class="col-left">
                            <h3 style="color:#1578f1; font-size:22px; margin:6px 0 18px;">{{ $kas->kantor }}</h3>
