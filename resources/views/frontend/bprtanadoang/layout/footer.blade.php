            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="single-footer-widget mb-100">
                    ...
                    <p style="text-align: justify; line-height:1.6; color: #fff;">
                        PT. BPR Tanadoang menyediakan layanan tabungan, deposito, dan kredit dengan pelayanan
                        profesional dan terpercaya untuk mendukung kebutuhan finansial masyarakat.
                    </p>

                    <div class="footer-social">
                        <a href="https://web.facebook.com/people/Bpr-Pesisir-Tanadoang/100089492877691/"><i
                                class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/bpr_bankpesisirtanadoang/"><i
                                class="fab fa-instagram"></i></a>
                        <a href="https://www.youtube.com/@BPRPESISIRTANADOANG"><i class="fab fa-youtube"></i></a>
