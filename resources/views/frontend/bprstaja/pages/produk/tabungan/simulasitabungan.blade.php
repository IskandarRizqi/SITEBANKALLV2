        ...
        <div style="width:83%; margin:auto; background:#0a6e22; padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
            ...
            <div class="simulasi-wrapper" style="display:flex;">
                ...
                <div class="simulasi-right" style="width:45%; display:flex; align-items:center; justify-content:center;"
                    ...
                    <img id="gambarProduk" src="frontend/bprstaja/img/produk/tabungan/simulasitabungan.png"
            ...
            <div id="hasilSimulasiContainer" style="width:100%; margin-top:30px; display:none;">
                <div style="background:white; border-radius:10px; padding:20px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    <h4 style="color:#ff5500; margin-bottom:20px; text-align:center;">Hasil Simulasi Tabungan</h4>
