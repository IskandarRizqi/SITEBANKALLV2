...
@section('content')
    ...
    <style>
        .portfolio-warp {
            ...
            height: 100%; /* Pastikan elemen mengisi tinggi kolom */
            border: 1px solid #e0e0e0; /* Opsional: tambahkan border untuk melihat batas kartu */
            border-radius: 8px;
            overflow: hidden;
        ...
        .portfolio-img {
            height: 250px; /* TINGGI TETAP untuk gambar utama */
            overflow: hidden;
        }
        ...
        .portfolio-thumbnails .col-4 {
            padding: 2px; /* Jarak kecil antar thumbnail */
        }
        ...
        .portfolio-text {
            padding: 15px;
            text-align: center;
            margin-top: auto; /* Mendorong bagian teks ke bawah */
            background-color: #f8f9fa; /* Opsional: warna latar teks */
        }
        ...
        <div class="container">
            <div class="row">
                ...
                @foreach ($groupedGallery as $title => $items)
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item wow fadeInUp" data-wow-delay="{{ $loop->index * 0.1 }}s">
                        <div class="portfolio-warp">
                            
                            <!-- Gambar Utama dengan tinggi tetap -->
                            <div class="portfolio-img">
                                <a href="/recfil?display=true&rf={{ $items->first()->image }}" data-lightbox="gallery-{{ \Illuminate\Support\Str::slug($title) }}">
                                    <img src="/recfil?display=true&rf={{ $items->first()->image }}" alt="{{ $title }}">
                                </a>
                            ...
                            <div class="portfolio-text">
                                <h3>{{ $title }}</h3>
                                <a class="btn" href="/recfil?display=true&rf={{ $items->first()->image }}" data-lightbox="gallery-{{ \Illuminate\Support\Str::slug($title) }}">+</a>
                            </div>
