                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="service-item">
                                ...
                                <div class="service-text">
                                    <h3>Kredit</h3>
                                    <a class="btn" href="frontend/bprphm/img/produk/kredit/kredit.png" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="service-item">
                                ...
                                <div class="service-text">
                                    <h3>Tabungan</h3>
                                    <a class="btn" href="frontend/bprphm/img/produk/tabungan/tab.png" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item">
                                ...
                                <div class="service-text">
                                    <h3>Deposito</h3>
                                    <a class="btn" href="frontend/bprphm/img/produk/deposito/depo.png" data-lightbox="service">+</a>
                                </div>
                            </div>
                        </div>
            ...
            <div style="width:82%; margin:auto; background:#2c2e93; padding:35px; border-radius:15px; margin-top:60px; display:flex; flex-direction:column;"
                ...
                padding:12px 20px; margin-bottom:18px;">
                        ...
                        <div style="display:flex; justify-content:space-between; margin-top:5px; margin-bottom:20px;"
                            ...
                            <button id="btnReset"
                                style="width:40%; padding:12px; border-radius:30px; background:#cb201d;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="testimonial-slider-nav">
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-1.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-2.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-3.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-4.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-1.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-2.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-3.jpg" alt="Testimonial"></div>
                                <div class="slider-nav"><img src="frontend/bprphm/img/testimonial-4.jpg" alt="Testimonial"></div>
