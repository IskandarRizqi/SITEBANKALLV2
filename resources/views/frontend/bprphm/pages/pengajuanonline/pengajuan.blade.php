                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="/formpengajuankredit" style="text-decoration:none;color:inherit;">
                            <div class="team-box"
                                style="background:#7670f8f4;border-radius:8px;padding:25px 15px;text-align:center;margin-bottom:20px;cursor:pointer;transition:.3s;">
                                ...
                                <h5 style="margin-bottom:5px;color:#ffffff;">Kredit</h5>
                                <p style="font-size:15px;color:#e8e3e3;">Klik disini untuk mengisi formulir <br> pengajuan
                                    Kredit</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="/formpengajuantabungan" style="text-decoration:none;color:inherit;">
                            <div class="team-box"
                                ...
                                <h5 style="margin-bottom:5px;color:#ffffff;">Tabungan</h5>
                                <p style="font-size:15px;color:#e8e3e3;">Klik disini untuk mengisi formulir <br> pengajuan
                                    Tabungan</p>
                            </div>
                        </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="/formpengajuandeposito" style="text-decoration:none;color:inherit;">
                            <div class="team-box"
                                ...
                                <h5 style="margin-bottom:5px; color:#ffffff;">Deposito</h5>
                                <p style="font-size:15px;color:#e8e3e3;">
