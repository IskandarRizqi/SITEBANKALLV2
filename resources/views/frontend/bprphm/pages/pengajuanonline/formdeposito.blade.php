...
<div class="page-header">
    ...
    <div class="job-wrapper" style="max-width:1150px;margin:0px auto 40px;font-family:'Open Sans',sans-serif;color:#333;">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
            <a href="javascript:history.back()" style="text-decoration:none;color:#2c2e93;">
        ...
        <div style="width:100%;border-radius:6px;overflow:hidden;margin-bottom:20px;">
            <img src="{{ asset('frontend/bprtaruna/assets/img/produk/deposito/deposito.png') }}" class="gambar-pengajuan"
        ...
        <form action="/simpan-data-pengajuan" method="POST">
            ...
            <div style="background:#fff;border-radius:10px;padding:30px;box-shadow:0 8px 20px rgba(0,0,0,.08);">
                ...
                <h5 style="font-weight:700;color:#2c2e93;margin-bottom:20px;">Data Nasabah</h5>
                ...
                <h5 style="font-weight:700;color:#2c2e93;margin:25px 0 15px;">Data Pengajuan Deposito</h5>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6 mb-2">
                        <button type="submit"
                            style="width:100%;padding:12px;background:#2c2e93;border:none;border-radius:30px;color:#fff;font-weight:600;">Kirim</button>
                    </div>
                </div>
