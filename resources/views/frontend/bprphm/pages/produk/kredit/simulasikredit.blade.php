...
@section('content')
    ...
    <body class="body tg-heading-subheading animation-style3">
        ...
        <div style="width:83%; margin:auto; background:#2c2e93; padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
            ...
            <div class="simulasi-wrapper" style="display:flex;">
                ...
                <div class="simulasi-left" style="width:55%; color:white; padding-right:20px;" class="simulasi-left">
                    ...
                    <div style="display:flex; justify-content:space-between; margin-top:5px; margin-bottom:20px;"
                        ...
                        border:none; color:#cb201d; font-weight:bold; font-size:14px;">
                            Hitung
                        </button>
            ...
            <div id="hasilSimulasiContainer" style="width:100%; margin-top:30px; display:none;">
                <div style="background:white; border-radius:10px; padding:20px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    <h4 style="color:#cb201d; margin-bottom:15px; text-align:center;">Hasil Simulasi Pinjaman</h4>
    ...
    <script>
        ...
        <table style="width:100%; border-collapse:collapse;">
            <tr style="background:#cb201d; color:white; text-align:center;">
    ...
    `;
            ...
            // ====================================================
            html += `
        <tr style="background:#cb201d; text-align:center; font-weight:bold; color:white;">
