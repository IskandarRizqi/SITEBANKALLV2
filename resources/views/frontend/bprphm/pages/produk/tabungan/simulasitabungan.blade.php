        ...
        <div style="width:83%; margin:auto; background:#2c2e93; padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
            ...
            <div id="hasilSimulasiContainer" style="width:100%; margin-top:30px; display:none;">
                <div style="background:white; border-radius:10px; padding:20px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    <h4 style="color:#cb201d; margin-bottom:20px; text-align:center;">Hasil Simulasi Tabungan</h4>
                    <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                        <div style="width: 48%;">
                            <h5 style="color:#333; margin-bottom:5px;font-size:16px; ">Bunga + Saldo Tabungan</h5>
                            <p id="saldoKalehBunga" style="font-size: 15px; font-weight: bold; color:#cb201d;">Rp 0</p>
                        </div>
                        <div style="width: 48%;">
