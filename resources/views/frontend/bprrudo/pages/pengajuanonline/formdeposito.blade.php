...
@section('content')
    ...
    <div class="job-wrapper" style="max-width:1150px;margin:120px auto 40px;font-family:'Open Sans',sans-serif;color:#333;">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
            ...
            <div style="font-size:25px;font-weight:700;color:#c62828;">Form Pengajuan Deposito</div>
        </div>

        <div style="width:100%;border-radius:6px;overflow:hidden;margin-bottom:20px;">
            <img src="{{ asset('frontend/bprrudo/assets/img/produk/deposito/deposito.png') }}" class="gambar-pengajuan"
        ...
        <form action="/simpan-data-pengajuan" method="POST">
            ...
            <div style="background:#fff;border-radius:10px;padding:30px;box-shadow:0 8px 20px rgba(0,0,0,.08);">
                ...
                <h5 style="font-weight:700;color:#c62828;margin-bottom:20px;">Data Nasabah</h5>
                ...
                <h5 style="font-weight:700;color:#c62828;margin:25px 0 15px;">Data Pengajuan Deposito</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <textarea rows="3" style="width:100%;border-radius:20px;padding:12px 18px;border:1px solid #ccc;" id="cat_tmbhn"
                            name="cat_tmbhn"></textarea>
                    </div>
                </div>
