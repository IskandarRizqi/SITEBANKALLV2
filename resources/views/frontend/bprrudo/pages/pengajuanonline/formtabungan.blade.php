...
@section('content')
    ...
    <div class="job-wrapper" style="max-width:1150px;margin:120px auto 40px;font-family:'Open Sans',sans-serif;color:#333;">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
            ...
            <div style="font-size:25px;font-weight:700;color:#c62828;">Form Pengajuan Tabungan</div>
        </div>

        <div class="img-wrap" style="width:100%;border-radius:6px;overflow:hidden;margin-bottom:20px;">
            <img src="{{ asset('frontend/bprrudo/assets/img/produk/tabungan/tabungan.png') }}"
