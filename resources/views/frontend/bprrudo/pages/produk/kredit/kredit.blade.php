...
@section('content')
    ...
    <div style="width:100%; overflow:hidden; margin-top:100px;">
        <img src="{{ asset('frontend/bprrudo/assets/img/produk/kredit/kredit.png') }}" style="object-fit: fill; height: auto;"
    ...
    <div class="team2 team-page sp" style="padding-top: 0PX">
        <div class="container">
            <br>
            <h2 style="text-align: center; font-weight: bold; margin-bottom: 30px; color: #A62C3D;">Produk Kredit</h2>
            <div class="row">
