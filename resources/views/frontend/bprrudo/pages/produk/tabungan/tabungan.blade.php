...
@section('content')
    ...
    <div style="width:100%; overflow:hidden; margin-top:100px;">
        <img src="{{ asset('frontend/bprrudo/assets/img/produk/tabungan/tabungan.png') }}" alt="Banner"
            style="object-fit: fill; height: auto;" class="banner-img">
    </div>
    ...
    <div class="team2 team-page sp" style="padding-top: 50px">
        <div class="container">
            <h2 style="text-align: center; font-weight: bold; margin-bottom: 30px; color: #A62C3D;">Produk Tabungan</h2>
            <div class="row">
