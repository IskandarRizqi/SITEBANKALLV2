...
<div style="width:100%; overflow:hidden; margin-top:100px;">
    <img src="{{ asset('frontend/bprrudo/assets/img/profil/pengaduan.png') }}" alt="Banner"
        style=" width:100%; height: auto; max-height:auto; object-fit:fill; display:block;">
</div>


<!-- Running Text -->
<div style="width:100%; overflow:hidden; white-space:nowrap; position:relative; padding:10px 0;  margin-top:15px;">
    <div
        ...
        {{-- <h2 style="font-weight:600; color:#b80000; margin-bottom:20px; font-family:'Open Sans', sans-serif;"">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-12 text-center" style="margin-top:80px;">
                    <img src="{{ asset('frontend/bprrudo/assets/img/profil/pengaduan2.jpeg') }}"
                        alt="Ilustrasi Pengaduan" style="max-width: 100%; height: auto; object-fit:fill">
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 mb-3 text-center">
                    <a href="{{ asset('frontend/bprrudo/assets/img/profil/FORMPENGADUAN.docx') }}" class="btn btn-lg"
                        id="btnPengaduan" download style="width: 60%; padding: 10px 20px; background-color: #A62C3D; color: #ffffff;
                              font-size: 25px; border-radius: 30px; font-weight: 400;">
                        <i class="fas fa-file-word mr-2"></i> Form WBS
                    </a>
                </div>
            </div>
