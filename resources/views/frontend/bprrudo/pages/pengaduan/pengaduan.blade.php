        ...
        <section class="py-5 text-center">
            ...
            <div class="row justify-content-center mt-4" >
                <div class="col-md-12 text-center"  style="margin-top:80px;">
                    <img src="{{ asset('frontend/bprrudo/assets/img/profil/PENGADUAN.png') }}"
            ...
            <div class="row justify-content-center mb-3" style="margin-top: 50px">
             ...
             <div class="row justify-content-center">
                <div class="col-md-6 mb-3 text-center">
                    <a href="{{ asset('frontend/bprrudo/assets/img/profil/FORMPENGADUAN.docx') }}"
                       class="btn btn-lg"
                       id="btnPengaduan"
                       download
                       style="width: 60%; padding: 10px 20px; background-color: #A62C3D; color: #ffffff;
