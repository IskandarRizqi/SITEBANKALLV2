    ...
    <div class="breadcumb-wrapper" data-bg-src="{{asset('frontend/bprbhaktiriyadi/assets/img/bg/breadcumb-bg.jpg')}}">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title"> {{ $tabungan->title ?? 'Tabungan' }}</h1>
                <ul class="breadcumb-menu">
                    <li><a href="/">Kredit</a></li>
                    <li> {{ $tabungan->title ?? 'Tabungan' }}</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="job-wrapper">
    ...
    <div style="max-width:1200px;margin:0 auto;">
        ...
        <div style="margin-top:30px;">
            <a href="/formpengajuantabungan" style="display:inline-block; background:#1a902a; color:#fff; padding:12px 30px; border-radius:20px; font-size:16px; font-weight:600;
