...
<body class="body tg-heading-subheading animation-style3">
    ...
    <div style="width:83%; margin:auto;   background: linear-gradient(45deg, #091098, #ffffff); padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
        ...
        <div class="simulasi-wrapper" style="display:flex;">
            ...
            <div class="simulasi-left" style="width:55%; color:white; padding-right:20px;" class="simulasi-left">
                ...
                <div style="display:flex; align-items:center; background:white; border-radius:30px;
                    ...
                    <span style="color:#3733f9; font-weight:bold; margin-right:10px;">Rp.</span>
                ...
                <div style="background:white; border-radius:30px; padding:0; margin-bottom:30px;">
                    ...
                    <select name="bunga" id="bunga" style="width:100%; padding:0 20px; border-radius:30px;
                ...
                <div style="display:flex; justify-content:space-between; margin-top:5px; margin-bottom:20px;"
                    ...
                    <button id="btnReset" style="width:40%; padding:12px; border-radius:30px; background:#3733f9;
    ...
    <div style="width:83%; margin:auto;   background: linear-gradient(45deg, #091098, #ffffff); padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
        ...
        <div id="hasilSimulasiContainer" style="width:100%; margin-top:30px; display:none;">
            <div style="background:white; border-radius:10px; padding:20px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                ...
                <!-- BARIS 3: PAJAK (HANYA MUNCUL JIKA PLAFON > 7.500.000) -->
                <div id="rowPajak"
                    style="display: none; margin-bottom: 15px; padding: 12px; background:#fef2f2; border-radius:8px; border-left: 4px solid #e74c3c;">
                    <div style="display: flex; justify-content: space-between;">
                        <div style="width: 48%;">
                            <h5 style="color:#e74c3c; margin-bottom:5px;font-size:16px;">Potongan Pajak (20%)</h5>
                            <p id="nilaiPajak" style="font-size: 15px; font-weight: bold; color:#e74c3c;">- Rp 0</p>
                        </div>
                        <div style="width: 48%;">
                            <h5 style="color:#27ae60; margin-bottom:5px;font-size:16px;">Bunga Bersih Per Bulan</h5>
                            <p id="bungaBersih" style="font-size: 15px; font-weight: bold; color:#27ae60;">Rp 0</p>
                        </div>
                    </div>
                </div>

                <!-- BARIS INFO BEBAS PAJAK (HANYA MUNCUL JIKA PLAFON <= 7.500.000) -->
                <div id="rowBebasPajak"
                    style="display: none; margin-bottom: 15px; padding: 10px 15px; background:#f0fdf4; border-radius:8px; border-left: 4px solid #27ae60;">
                    <p style="font-size: 13px; color:#27ae60; margin:0; font-weight: 600;">
                        ✅ Bebas pajak bunga (Plafon ≤ Rp 7.500.000)
                    </p>
                </div>
                ...
                <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #eee;">
                    <small style="color:#666;">Syarat dan Ketentuan</small>
                    <ul class="bullet-list" style="font-size: 12px; color:#666; padding-left: 20px; margin-top: 5px;">
                        <li>Plafon di atas <strong>Rp 7.500.000</strong> dikenakan pajak bunga <strong>20%</strong></li>
                        <li>Plafon Rp 7.500.000 ke bawah <strong>bebas pajak bunga</strong></li>
                        <li>Belum Termasuk Biaya Admin</li>
                        <li>Suku bunga dapat berubah sewaktu-waktu mengikuti ketentuan yang berlaku</li>
                        <li>Simulasi ini merupakan ilustrasi perhitungan dari system
                            <strong>{{ env('APP_NAME', 'Bank') }}</strong>
                        </li>
...
<script>
    // FORMAT RUPIAH
        ...
        document.getElementById("btnHitung").addEventListener("click", function() {
            ...
            let split = type.split('-');
            let bulan = parseFloat(split[0]);
            let bunga = parseFloat(split[1]);

            // RUMUS BUNGA KOTOR PER BULAN
            let hasil = plafon * (bunga / 100) / 12;
            let saldoDenganBunga = plafon + hasil;

            // ISI DATA UTAMA (TETAP SAMA)
            document.getElementById("saldoKalehBunga").innerText = formatRupiah(saldoDenganBunga);
            document.getElementById("saldo").innerText = formatRupiah(plafon);
            document.getElementById("hasilBunga").innerText = formatRupiah(hasil);
            document.getElementById("totalSetoran").innerText = formatRupiah(plafon);

            // CEK PAJAK: LEBIH DARI 7.500.000
            if (plafon > 7500000) {
                let pajak = hasil * 0.20; // potongan 20%
                let bersih = hasil - pajak;

                document.getElementById("nilaiPajak").innerText = "- " + formatRupiah(pajak);
                document.getElementById("bungaBersih").innerText = formatRupiah(bersih);
                document.getElementById("rowPajak").style.display = "block";
                document.getElementById("rowBebasPajak").style.display = "none";
            } else {
                document.getElementById("rowPajak").style.display = "none";
                document.getElementById("rowBebasPajak").style.display = "block";
            }
        ...
        document.getElementById("btnReset").addEventListener("click", function() {
            ...
            document.getElementById("rowPajak").style.display = "none";
            document.getElementById("rowBebasPajak").style.display = "none";
            document.getElementById("gambarProduk").src = "frontend/bprdatagita/img/produk/simulasideposito.png";
        });
</script>
<script>
    document.getElementById("bunga").addEventListener("change", function() {
