...
@section('content')
    ...
    <div class="breadcumb-area style2 bg-smoke4">
        <div class="breadcumb-wrapper" data-bg-src="{{asset('frontend/bprbhaktiriyadi/assets/img/bg/breadcumb-bg.jpg')}}">
            <div class="container">
                <div class="breadcumb-content">
                    <h1 class="breadcumb-title">Detail Lelang</h1>
                    <ul class="breadcumb-menu">
                        <li><a href="index.html">Lelang</a></li>
                        <li>Detail Lelang</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="details-post-area">
                        ...
                        <ul class="nav nav-tabs border-0 mb-3 small" id="detailTab" role="tablist"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="uraian-tab" data-bs-toggle="tab" href="#uraian" role="tab" aria-controls="uraian" aria-selected="true">Uraian</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="penjual-tab" data-bs-toggle="tab" href="#penjual" role="tab" aria-controls="kodelot" aria-selected="false">Kode Lot</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="penyelenggara-tab" data-bs-toggle="tab" href="#penyelenggara" role="tab" aria-controls="penyelenggara" aria-selected="false">Info Penyelenggara</a>
                            </li>
                        </ul>
