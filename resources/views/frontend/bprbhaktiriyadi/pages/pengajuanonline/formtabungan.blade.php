    ...
    <div class="breadcumb-wrapper" data-bg-src="frontend/bprbhaktiriyadi/assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Form Pengajuan Tabungan</h1>
                <ul class="breadcumb-menu">
                    <li><a href="/">Beranda</a></li>
                    <li>Form Pengajuan Tabungan</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="job-wrapper" style="max-width:1150px;margin:0px auto 40px;font-family:'Open Sans',sans-serif;color:#333;">
    ...
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
        <a href="javascript:history.back()" style="text-decoration:none;color:#091098;">
    ...
    <form action="/simpan-data-pengajuan" method="POST">
        ...
        <div style="background:#fff;border-radius:10px;padding:30px;box-shadow:0 8px 20px rgba(0,0,0,.08);">
            ...
            <h5 style="font-weight:700;color:#091098;margin-bottom:20px;">Data Nasabah</h5>
            ...
            <h5 style="font-weight:700;color:#091098;margin:25px 0 15px;">Data Pengajuan Tabungan </h5>

            <div class="row">
                <div class="col-lg-6 mb-3">
                    <label style="font-weight:600;margin-bottom:5px;">Jenis Tabungan <span style="color:red">*</label>
                    <select style="width:100%;border-radius:30px;padding:12px 18px;border:1px solid #ccc;" id="jns_tab"
                        name="jns_tab" required>
            ...
            <div class="row mt-4">
                <div class="col-lg-6 mb-2">
                    <a href="javascript:history.back()"
                        style="display:block;width:100%;padding:10px;text-align:center;border:2px solid #091098;border-radius:30px;color:#091098;font-weight:600;text-decoration:none;">Batal</a>
                </div>
                <div class="col-lg-6 mb-2">
                    <button type="submit"
                        style="width:100%;padding:12px;background:#091098;border:none;border-radius:30px;color:#fff;font-weight:600;">Kirim</button>
                </div>
            </div>
