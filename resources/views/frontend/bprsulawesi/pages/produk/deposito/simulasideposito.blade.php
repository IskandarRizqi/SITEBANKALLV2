...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Simulasi Deposito</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <body class="body tg-heading-subheading animation-style3">
        ...
        <div style="width:83%; margin:auto;   background: linear-gradient(45deg,#ff6804, #0b1c87); padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
