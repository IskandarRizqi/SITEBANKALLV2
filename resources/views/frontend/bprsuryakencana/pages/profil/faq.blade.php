        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 d-flex justify-content-center">
                    <div class="accordion accordion1 accordion-flush w-100" id="accordionFlushExample" style="text-align: left;">
                ...
                <!-- Kolom Kanan -->
                <div class="col-lg-6 d-flex justify-content-center">
                    <div class="accordion accordion2 accordion-flush w-100" id="accordionFlushExample2" style="text-align: left;">
                        ...
                        <div class="accordion-item active" data-aos="fade-up" data-aos-duration="1200">
                            ...
                            <div id="flush-collapseTen" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <p><strong>Kredit:</strong> Kredit Modal Usaha, Kredit Multiguna, Kredit Investasi, Kredit Konsumtif</p>
