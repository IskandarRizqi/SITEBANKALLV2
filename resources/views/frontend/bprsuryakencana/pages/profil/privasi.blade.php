...
@section('content')
    <div class="breadcumb-area style2 bg-smoke4">
        <div class="breadcumb-wrapper" data-bg-src="frontend/bprsuryakencana/assets/img/bg/breadcumb-bg.jpg">
            <div class="container">
                            ...
                            <div class="details-post-area">
                                ...
                                <div class="heading1">
                                  <br>
                                    ...
                                    <p><strong>5. Persetujuan</strong></p> <!-- Mengubah nomor 6 menjadi 5 untuk konsistensi -->
                                    <p style="text-align: justify">
                                        Dengan menggunakan situs ini, Anda menyetujui pengumpulan dan penggunaan data
                                        Anda sebagaimana dijelaskan dalam kebijakan ini.
                                    </p>
