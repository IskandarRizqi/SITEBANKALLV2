        ...
        <div class="row">
            <div class="col">
                <div class="pxn_page_header_content" style="text-align: center;">
                    <h1 class="page_title">Jaringan Kantor</h1>
                    <div class="pxn_breadcrumb">
                        <span><a href="/">Profil</a></span>
                        /
                        <span class="current">Jaringan Kantor</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="page-wrap">
    <div class="slider-box" aria-label="Slider Kantor">
        {{-- <h2 style="text-align:center; font-weight:700; color:#41ab17; margin:26px 0 8px;">JARINGAN KANTOR</h2> --}}
        <div id="slideViewport" role="list">
            ...
            <section class="slide" role="listitem" aria-label="Kantor Pusat" style="padding: 25px 60px">
                <div class="row">
                    <div class="col-left">
                        <h3 style="color:#41ab17; font-size:22px; margin:6px 0 18px;">Kantor Pusat</h3>
            ...
            <section class="slide" role="listitem" aria-label="Kantor Cabang" style="padding: 25px 60px">
                <div class="row">
                    <div class="col-left">
                        <h3 style="color:#41ab17; font-size:22px; margin:6px 0 18px;">{{ $cabang->kantor }}</h3>
            ...
            <section class="slide" role="listitem" aria-label="Kantor Cabang 2" style="padding: 25px 60px">
                <div class="row">
                    <div class="col-left">
                        <h3 style="color:#41ab17; font-size:22px; margin:6px 0 18px;">{{ $kas->kantor }}</h3>
