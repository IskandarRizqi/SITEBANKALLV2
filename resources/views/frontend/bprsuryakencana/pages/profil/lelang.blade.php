...
<style>
    ...
    .auction-card:hover {
        background: linear-gradient(45deg, #17970b, #f55e13);
        /* biru */
        color: #fff !important;
    ...
    .auction-card:hover .btn {
        background: #eb6817 !important;
        border-color: #eb6817 !important;
        color: #fff !important;
    }
        ...
        <div class="row">
            <div class="col">
                <div class="pxn_page_header_content" style="text-align: center;">
                    <h1 class="page_title">Lelang</h1>
                    <div class="pxn_breadcrumb">
                        <span><a href="/">Beranda</a></span>
                        /
                        <span class="current">Lelang</span>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="auction-card shadow-sm border-0">
                                        ...
                                        <div class="p-3 text-center">
                                            ...
                                            <span class="btn btn-sm w-100 fw-bold"
                                                style="background-color: #24ba33; color: #fff;">OPEN
                                                BIDDING</span>
                                        </div>
                                    </div>
                                </a>
