            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                <a href="javascript:void(0)" onclick="comingSoon()">
                    <div class="box p-8 zoom-in cursor-pointer transition duration-300 hover:shadow-lg">
                        <!-- Gambar -->
                        <div class="flex justify-center mb-4">
                            <img src="/frontend/nusaintim/assets/img/user/ceksaldo.png" class="w-20 h-20 object-contain"
                                alt="Cek Saldo">
                        </div>
                        <!-- Judul -->
                        <div class="text-center font-semibold text-lg">
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                <a href="javascript:void(0)" onclick="comingSoon()">
                    <div class="box p-8 zoom-in cursor-pointer transition duration-300 hover:shadow-lg">
                        <!-- Gambar -->
                        <div class="flex justify-center mb-4">
                            <img src="/frontend/nusaintim/assets/img/user/pengajuan.png" class="w-20 h-20 object-contain"
                                alt="Cek Saldo">
                        </div>
                        <!-- Judul -->
                        <div class="text-center font-semibold text-lg">
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                <a href="/lacak-pengaduan">
                    <div class="box p-8 zoom-in cursor-pointer">
                        ...
                        <div class="flex justify-center mb-4">
                            <img src="/frontend/nusaintim/assets/img/user/pengaduan.png" class="w-20 h-20 object-contain">
                        </div>
