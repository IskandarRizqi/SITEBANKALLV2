              ...
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35PX">DEPOSITO</h1>
                    <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Produk <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Deposito</span>
                </div>
              </div>
            </div>
          </div>
                                ...
                                <div class="details-post-area">
                                    ...
                                    <div class="space30"></div>
                                     <div class="heading1">
                                        ...
                                        <p>Deposito di BPR (Bank Perkreditan Rakyat) adalah produk simpanan berjangka yang disimpan dalam waktu tertentu dan hanya bisa dicairkan saat jatuh tempo. Deposito memberikan bunga lebih tinggi dibanding tabungan biasa, sehingga cocok untuk investasi jangka pendek atau menengah dengan risiko rendah.</p> <br>
