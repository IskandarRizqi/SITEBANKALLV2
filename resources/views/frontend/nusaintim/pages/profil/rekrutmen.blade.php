              ...
              <div class="col-lg-8 m-auto">
                <div class="main-heading">
                  <h1 style="font-size: 35px">E-RECRUITMENT</h1>
                    <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Rekrutment <span class="arrow">
                </div>
              </div>
            </div>
          </div>
                                    ...
                                    <div class="col-lg-6">
                                      <div class="blog2-box">
                                        <div class="image">
                                          ...
                                          <div class="heading1">
                                            <div class="tags">
                                              <a href="#" class="date"><img src="frontend/bprjas/assets/img/icons/date.png" alt="">   {{ \Carbon\Carbon::parse($item->tanggal_posting)->format('d/m/Y') }}</a>
                                              <a href="#" class="date outhor">
                                                <img src="{{ asset('frontend/bprjas/assets/img/icons/user.png') }}" alt="">
                                                {{ $item->tipe_pekerjaan_text }}
                                              </a>
                                            </div>
                                            <h4><a href="{{ route('detrekrutmen', $item->id) }}" style="font-size: 20px;">{{ $item->judul }}</a></h4>
                                            <div class="space16"></div>
                                            {{-- <p>We explore the growing trend of remote work and its implications for cybersecurity.</p> --}}
                                            <div class="space16"></div>
                                            <a href="{{ route('detrekrutmen', $item->id) }}" class="learn">Selengkapnya <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                          </div>
                                      </div>
                                    </div>
                                  @endforeach
