    ...
    <div class="row align-items-center text-center">
      <div class="col-lg-8 m-auto">
        <div class="main-heading">
          ...
          <span class="span">
           <span class="span"><img src="frontend/bprjas/assets/img/icons/span1.png" alt=""> <a href="index.html">Home</a> <span class="arrow"><i class="fa-regular fa-angle-right"></i></span> Pengaduan Online</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center mb-4">
      <div class="col-lg-8">
        <p class="lead text-muted">
          Kami menyediakan sarana bagi masyarakat untuk menyampaikan pengaduan dan pelanggaran yang terjadi di lingkungan sekitar secara cepat dan mudah.
        </p>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row text-center align-items-start">
      ...
      <div class="col-md-3 mb-4">
        <img src="/frontend/nusaintim/assets/img/logo/alur1.png" class="alur-icon mb-3" alt="step1" style="height: 150px; width: 150px;">
        <h5 class="font-weight-bold">Konsumen Menyampaikan Pengaduan</h5>
        <p class="text-muted">
          Konsumen menyampaikan pengaduan melalui sarana yang tersedia dengan dilengkapi informasi identitas, kronologi kejadian dan dokumen pendukung lainnya.
        </p>
      </div>

      <div class="col-md-3 mb-4">
        <img src="/frontend/nusaintim/assets/img/logo/alur2.png" class="alur-icon mb-3" alt="step2" style="height: 150px; width: 150px;">
      ...
      <div class="col-md-3 mb-4">
        <img src="/frontend/nusaintim/assets/img/logo/alur3.png" class="alur-icon mb-3" alt="step3" style="height: 150px; width: 150px;">
      ...
      <div class="col-md-3 mb-4">
        <img src="/frontend/nusaintim/assets/img/logo/alur4.png" class="alur-icon mb-3" alt="step4" style="height: 150px; width: 150px;">
        <h5 class="font-weight-bold">Penyelesaian Pengaduan</h5>
        <p class="text-muted">
          Bila konsumen menyepakati hasil penelitian maka pengaduan dianggap selesai. Bila tidak, konsumen dapat melakukan penyelesaian sengketa ke lembaga terkait.
        </p>
      </div>
          ...
          <div class="tab-pane" id="otpTab" role="tabpanel">
            ...
            <form id="formOtp">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="otp_code" placeholder="Masukkan 6 digit kode OTP" maxlength="6" required>
              </div>
            ...
            <div class="text-center mt-3">
              <p>Tidak menerima email? Periksa folder spam atau <a href="#" id="btnResendOtpLink">kirim ulang OTP</a></p>
            </div>
          </div>
        </div>
      </div>
...
<div class="modal fade" id="modalFormAduan" tabindex="-1" role="dialog" aria-labelledby="modalFormAduanLabel" aria-hidden="true">
          ...
          <div class="col-md-12" id="jenis_opsi_container" style="display:none;">
            <div class="form-group">
                <div class="form-check form-check-inline">
                    <input class="form-check-input kategoriCheck" type="checkbox" id="opsi_perusahaan" name="kategori[]" value="Perusahaan">
                    <label class="form-check-label" for="opsi_perusahaan">Perusahaan</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input kategoriCheck" type="checkbox" id="opsi_perorangan" name="kategori[]" value="Perorangan">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control-file" accept="audio/*,video/*" name="bukti2[]" id="bukti2_input">
          ...
          <div class="form-section-dinamis" data-jenis-id="2">
            <div class="row">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      <label>Bukti Suara/Video (maks 5 file)</label>
                      <input type="file" class="form-control-file" accept="audio/*,video/*"  name="bukti2xx[]" id="bukti2_input">
                      <ul id="bukti2_list" class="file-list"></ul>
                  </div>
              </div>
            </div>
