...
@section('content')
    ...
    <div class="team2 team-page sp" style="padding-top:0px">
        <div class="container" style="margin-top: 50px">
            ...
            <div style=" border:1.5px solid #2d4091 ; border-radius:8px; padding:30px 15px; margin-bottom: 30px;">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="/formpengajuankredit" style="text-decoration:none;color:inherit;">
                            <div class="team-box"
                                style="background:  #2d4091;border-radius:8px;padding:25px 15px;text-align:center;margin-bottom:20px;cursor:pointer;transition:.3s;">
