...
@section('content')
    ...
    <body class="body tg-heading-subheading animation-style3">
        ...
        <div id="superParentContainer" class="container pb-3" style="padding-top: 50px; padding-bottom: 60px;">
                <h5 class="display-4 wow fadeInDown" style="color: #000; text-align: center; font-size: 40px;" data-wow-delay="0.1s">LAPORAN LAINNYA</h5>
