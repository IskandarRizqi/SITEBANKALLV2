    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a class="navbar-brand" href="#">
                <img src="{{ asset('frontend/bprkotamagelang/assets/img/logo/logo1.png') }}" alt="Logo" width="270px;" style="height: 50px;">
            </a>
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li class="dropdown"><a href="#" class="nav-link {{ request()->is('publikasi', 'tahunan', 'tatakelola', 'keberlanjutan', 'piagamaudit') ? 'active' : '' }}"><span>Laporan</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
