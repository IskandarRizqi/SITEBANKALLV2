        ...
        <div class="row gx-0 align-items-center" style="height: 45px;">
            <div class="col-lg-8 text-center text-lg-start mb-lg-0">
                <div class="d-flex flex-wrap">
                    <a href="https://www.google.com/maps/place/BPR+SAHABAT+TATA/@-6.9631768,109.1300091,17z/data=!4m14!1m7!3m6!1s0x2e6fb9ca150b9523:0x5608c55a5411f124!2sBPR+SAHABAT+TATA!8m2!3d-6.9631821!4d109.132584!16s%2Fg%2F11vb5qjkfc!3m5!1s0x2e6fb9ca150b9523:0x5608c55a5411f124!8m2!3d-6.9631821!4d109.132584!16s%2Fg%2F11vb5qjkfc?entry=ttu&g_ep=EgoyMDI2MDMyNC4wIKXMDSoASAFQAw%3D%3D"
                        class="text-white me-4 " target="_blank"><i
                            class="fas fa-map-marker-alt text-white me-2"></i>Maps</a>
                    <a href="#" class="text-white me-4"><i class="fas fa-phone-alt text-white me-2"></i>08232493412</a>
                    <a href="#" class="text-white me-0"><i class="fas fa-envelope text-white me-2"></i>
                        bprsahabattata@gmail.com</a>
                </div>
            </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="/keberlanjutan"
                                ...
                                Keberlanjutan</a>
                            <a href="/akb" class="dropdown-item {{ request()->is('akb') ? 'active' : '' }}">Laporan
                                AKB</a>
                            <a href="/piagamaudit"
