             ...
             <div class="col-md-6 col-lg-6 col-xl-3">
                 <div class="footer-item d-flex flex-column">
                     <div class="footer-item">
                         ...
                         <p class="mb-3" style="color: #fff">PT. BPR Sahabat Tata Menghimpun dana dari masyarakat, Baik
                             dalam bentuk
                             simpanan, deposito dan tabungan.</p>
                         <div class="d-flex align-items-center">
                             ...
                             <a class="btn btn-light btn-md-square me-2"
                                 href="https://www.instagram.com/pt.bprsahabattatatgl/"><i
             ...
             <div class="col-md-6 col-lg-6 col-xl-3">
                 <div class="footer-item d-flex flex-column">
                     ...
                     <a href="#" style="color: #fff"><i class="fa fa-map-marker-alt me-2"
                             style="color: #fff"></i>Jl. Anoa No.4, Harjosari Kidul, Adiwerna
                         Kabupaten Tegal</a>
                     <a href="#" style="color: #fff"><i class="fas fa-envelope me-2" style="color: #fff"></i>
                         bprsahabattata@gmail.com</a>
                     <a href="#" style="color: #fff"><i class="fas fa-phone me-2" style="color: #fff"></i>
                         +(0283)4565265</a>
                     <a href="#" style="color: #fff" class="mb-3"><i class="fas fa-print me-2"
                             style="color: #fff"></i>08232493412</a>
         ...
         <div class="row g-4 align-items-center">
             <div class="col-md-6 text-center text-md-start mb-md-0">
                 <span style="color:#fff;">
                     ...
                     support by
                     <a href="https://antaruang.com" style="color:#0d6efd;">
                         Antar Uang
                     </a>
                 </span>
             </div>
