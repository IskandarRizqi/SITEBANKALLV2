...
<div class="job-wrapper">
    ...
    <div style="max-width:1200px;margin:0 auto;">
        ...
        <div style="margin-top:30px;">
            <a href="/formpengajuandeposito" style="display:inline-block; background:#c20909; color:#fff; padding:12px 30px; border-radius:20px; font-size:16px; font-weight:600;
