        ...
        <div class="row">
            <div class="col">
                <div class="pxn_page_header_content" style="text-align: center;">
                    <h1 class="page_title"> {{ $kredit->title ?? 'Kredit' }}</h1>
                    <div class="pxn_breadcrumb">
                        <span><a href="/">Produk</a></span>
                        /
                        <span class="current"> {{ $kredit->title ?? 'Kredit' }}</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="job-wrapper">
    ...
    <div style="max-width:1200px;margin:0 auto;">
        ...
        <div style="margin-top:30px;">
            <a href="/formpengajuankredit" style="display:inline-block; background:#c20909; color:#fff; padding:12px 30px; border-radius:20px; font-size:16px; font-weight:600;
