        ...
        <div class="row">
            <div class="col">
                <div class="pxn_page_header_content" style="text-align: center;">
                    <h1 class="page_title">Pengaduan Nasabah</h1>
                    <div class="pxn_breadcrumb">
                        <span><a href="/">Beranda</a></span>
                        /
                        <span class="current">Pengaduan Nasabah</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 mb-3">
                <a href="#" class="btn btn-lg" id="btnPengaduan"
                    style=" width: 80%; padding: 15px 7px;  background-color: #0a1c92; color: #ffffff;font-size: 25px; border-radius: 30px;">
