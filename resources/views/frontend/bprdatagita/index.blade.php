    ...
    <body>
            ...
            <div class="blog sp">
                <div class="container">
                    <div class="section-header text-center">
                        {{-- <p>UMKM</p> --}}
                        <h2 style="margin-bottom: 50px;">UMKM BPR Datagita Mustika</h2>
                    </div>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-features-area mb-100 wow fadeInUp" data-wow-delay="300ms">
                            <img src="frontend/bprdatagita/img/produk/kredit.png" alt="">
                            <h5>Kredit</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-features-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                            <img src="frontend/bprdatagita/img/produk/deposito.png" alt="">
                            <h5>Deposito</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-features-area mb-100 wow fadeInUp" data-wow-delay="700ms">
                            <img src="frontend/bprdatagita/img/produk/tabungan.png" alt="">
                            <h5>Tabungan</h5>
        ...
        <section class="cta-area d-flex flex-wrap">
            ...
            <div class="cta-thumbnail bg-img jarallax"
                style="background-image: url(frontend/bprdatagita/img/bg-img/5.jpg);"></div>
        </section>
        <!-- ##### Call To Action End ###### -->
                    ...
                    <!-- Add Area -->
                     ...
                     <div class="col-12 col-md-6 col-lg-8">
                        <div class="add-area mb-100 wow fadeInUp" data-wow-delay="100ms">
                            <a href="#"><img src="frontend/bprdatagita/img/profil/centertop.png" alt=""></a>
                        </div>
                    </div>
