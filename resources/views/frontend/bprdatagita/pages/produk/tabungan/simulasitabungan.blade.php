...
@section('content')
   ...
   <section class="breadcrumb-area bg-img bg-overlay jarallax"
    ...
    <body class="body tg-heading-subheading animation-style3">
        ...
        <div style="width:83%; margin:auto; background:#19178e; padding:35px; border-radius:15px; margin-top:50px; margin-bottom: 50px; display:flex; flex-direction:column;"
            ...
            <div class="simulasi-wrapper" style="display:flex;">
                ...
                <div class="simulasi-left" style="width:55%; color:white; padding-right:20px;" class="simulasi-left">
                    ...
                    <div style="display:flex; justify-content:space-between; margin-top:5px; margin-bottom:20px;"
                        ...
                        <button id="btnReset"
                            style="width:40%; padding:12px; border-radius:30px; background:#1a902a;
                        ...
                        border:none; color:#1a902a; font-weight:bold; font-size:14px;">
                            Hitung
                        </button>
            ...
            <div id="hasilSimulasiContainer" style="width:100%; margin-top:30px; display:none;">
                <div style="background:white; border-radius:10px; padding:20px; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    <h4 style="color:#1a902a; margin-bottom:20px; text-align:center;">Hasil Simulasi Tabungan</h4>
                    <div style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                        <div style="width: 48%;">
                            <h5 style="color:#333; margin-bottom:5px;font-size:16px; ">Bunga + Saldo Tabungan</h5>
                            <p id="saldoKalehBunga" style="font-size: 15px; font-weight: bold; color:#1a902a;">Rp 0</p>
                        </div>
                        <div style="width: 48%;">
