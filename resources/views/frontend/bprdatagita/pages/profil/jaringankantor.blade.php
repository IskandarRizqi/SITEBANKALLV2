                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Jaringan Kantor</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
{{-- 
    ...
    <div class="page-wrap">
        <div class="slider-box" aria-label="Slider Kantor">
            {{-- <h2 style="text-align:center; font-weight:700; color:#19178e; margin:26px 0 8px;">JARINGAN KANTOR</h2> --}}
            <div id="slideViewport" role="list">
                ...
                <section class="slide" role="listitem" aria-label="Kantor Pusat" style="padding: 25px 60px">
                    <div class="row">
                        <div class="col-left">
                            <h3 style="color:#19178e; font-size:22px; margin:6px 0 18px;">Kantor Pusat</h3>
                ...
                <section class="slide" role="listitem" aria-label="Kantor Cabang" style="padding: 25px 60px">
                    <div class="row">
                        <div class="col-left">
                            <h3 style="color:#19178e; font-size:22px; margin:6px 0 18px;">{{ $cabang->kantor }}</h3>
                        ...
                        <div class="col-right">
                            <a href="https://www.google.com/maps?q={{ $pusat->latitude }},{{ $pusat->longitude }}" target="_blank">
                                <img src="/recfil?display=true&rf={{ $pusat->thumbnail }}" 
                                    alt="peta kantor pusat"
                                    style="width:100%; border-radius:10px;">
                            </a>
                        </div>
                ...
                <section class="slide" role="listitem" aria-label="Kantor Cabang 2" style="padding: 25px 60px">
                    <div class="row">
                        <div class="col-left">
                            <h3 style="color:#19178e; font-size:22px; margin:6px 0 18px;">{{ $kas->kantor }}</h3>
                        ...
                        <div class="col-right">
                             <a href="https://www.google.com/maps?q={{ $kas->latitude }},{{ $kas->longitude }}" target="_blank">
                            <img src="/recfil?display=true&rf={{ $kas->thumbnail }}"
                                alt="peta kantor pusat" style="width:100%; border-radius:10px;">
                            </a>
                        </div>
                    </div>
                </section>
